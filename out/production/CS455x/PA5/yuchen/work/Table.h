...
class Table {
 ...
 private:
   ...
   /**
      ...
      hashSize > 0 and remains unchanged after initialization
      hashTable is NOT NULL and its index range is [0, hashSize)
      The index of hashTable is the hashCode of the corresponding chain/string
      hashTable stores the heads of the linked lists
      numEntry >= 0
    */
};
